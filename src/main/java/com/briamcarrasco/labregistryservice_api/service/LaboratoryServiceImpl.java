...
/**
 * Implementación de la interfaz {@link LaboratoryService} para la gestión de laboratorios.
 * Proporciona operaciones CRUD y búsquedas personalizadas sobre la entidad Laboratory.
 * Maneja la excepción de recurso duplicado al intentar guardar laboratorios con nombre repetido.
 */
@Service
public class LaboratoryServiceImpl implements LaboratoryService {
     ...
     * @throws DuplicateResourceException si ya existe un laboratorio con el mismo nombre.
     */
    @Override
