 ...
 * Incluye información relevante como nombre, dirección, teléfono, correo electrónico, sitio web y especialidad.
...
public class Laboratory {
    ...
    //Getters y Setters se generan automáticamente con la anotación @Data de Lombok
