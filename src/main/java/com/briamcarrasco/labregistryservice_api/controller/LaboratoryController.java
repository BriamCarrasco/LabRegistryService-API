 ...
 * Proporciona endpoints para operaciones CRUD y búsquedas personalizadas sobre la entidad Laboratory.
 * Documentado con Swagger/OpenAPI para facilitar la exploración y prueba de la API.
 */
